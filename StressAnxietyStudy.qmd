...
This research was selected for a poster presentation at the **2026 Midwestern Psychological Association (MPA) Annual Meeting** in Chicago, IL on April 17, 2026.
:::
...
Results from a one-way between-subjects ANOVA showed no significant effect of condition on post-TSST STAI-6 scores, F(2, 33) = 0.07, p = 0.94.

![Post-TSST STAI-6 Scores by Condition](images/figure1_post_tsst.png){#fig-post-tsst width=70%}

### Post-Recovery Anxiety

Results from a one-way between-subjects ANOVA showed no significant effect of condition on post-recovery STAI-6 scores, F(2, 33) = 0.40, p = 0.68.
...
Results from a one-way between-subjects ANOVA showed no significant effect of condition on change in STAI-6 scores, F(2, 33) = 1.15, p = 0.33.
